...
$commentaires->supprimerCommentaire($_POST['id_commentaire']);
...
<?php if($arrayC!=null):?>
    ...
    <div class="row paddingCommentaire" >
      ...
      <div class="col-xs-12 col-md-8 pCommentaire">    
       ...
       <button name="supprimerC" class="supprimerC btn btn-danger" id="supprimerC"  data_id_s="<?=$value['id']?>">Supprimer
       </button>
