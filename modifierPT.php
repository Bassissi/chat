...
if (isset($_POST['submit'] ) && $type=='perdu')
	{
	    ...
	    // vérifier de l'image 
	     ...
	     // vérifier de date pedru ou date trouvé 
            ...
            // vérifier si l'utilisateur met le même nom d'image toujours                
 /*
  ...
  */         
			...
			*/
		      ...
		      */
		        ...
		        $annonce2->ecrireAnnonce($_POST['nom'],$_POST['sex'],$url,$_POST['race'],$couleurs,$_POST['poils'],$_POST['pelage'],$_POST['castre'],$datePT,$rue,$_POST['arrondissement'],$_POST['description'],$_POST['phone'],$dateNaissance);
       ...
       {    
             ...
             $annonce2=new Annonce('trouve');
               ...
               */
		        ...
		        $annonce2->supprimerAnnonce($idchat); 
		        $annonce2->ecrireAnnonce($nom,$_POST['sex'],$url,$_POST['race'],$couleurs,$_POST['poils'],$_POST['pelage'],$_POST['castre'],$datePT,$rue,$_POST['arrondissement'],$_POST['description'],$_POST['phone'],$dateNaissance);
