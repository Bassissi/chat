...
$annonce=new Annonce($type);
    ...
    else
    {
    	...
    	if($typeM=='trouve')
    		$typeM='trouvé'; 
    	$templateTitle='supprimer une annonce chat '.$typeM; 
	    $templateDescription='dans cette partie on peut supprimer une annonce chat '.$typeM." facilement par la date de naissance de l'utilisateur";
	    $templateKeywords='supprimer, annonce, chat, '.$typeM; 
    	include 'layout.phtml';
    }
